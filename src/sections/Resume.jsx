      ...
      <div className="container-p">
        ...
        <div className="bg-white border border-espresso-200 shadow-card rounded-2xl px-6 sm:px-10 py-10 max-w-4xl mx-auto text-espresso-800">
          ...
          <Block title="Experience">
            <Entry title="Royal Caribbean Group — IT Shipboard Engineering Intern" meta="June 2026 - Aug 2026" sub="Miramar, FL"
              bullets={[
                'In progress of this summer 2026 internship on the IT shipboard engineering team for Royal Carribean.',
              ]} />
